...
## 统计信息
- 最后更新时间：2025-08-22 00:38:30
- Hosts规则数量：14195

### 各拦截器规则数量
- Adblock Plus 混合规则数量：10547
- uBlock Origin 混合规则数量：15213
- AdGuard 拦截规则数量：10631
- AdGuard 白名单数量：4670
- AdGuard Home 拦截规则数量：10304
- AdGuard Home 白名单数量：4665
- Clash 混合规则数量：10205（若文件不存在）
- Surge 混合规则数量：0（若文件不存在）
- Pi-hole 拦截规则数量：14195
- Pi-hole 白名单数量：3130
