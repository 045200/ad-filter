...
## 统计信息
- 最后更新时间：2025-08-24 10:43:00
- Hosts规则数量：0

### 各拦截器规则数量
- Adblock Plus 混合规则数量：646
- uBlock Origin 混合规则数量：646
- AdGuard 拦截规则数量：646
- AdGuard 白名单数量：8176
- AdGuard Home 拦截规则数量：646
- AdGuard Home 白名单数量：8176
- Clash 混合规则数量：5189（若文件不存在）
- Surge 混合规则数量：2596（若文件不存在）
- Pi-hole 拦截规则数量：0
- Pi-hole 白名单数量：2594
