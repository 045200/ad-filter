...
## 统计信息
- 最后更新时间：2025-08-23 15:16:14
- Hosts规则数量：0

### 各拦截器规则数量
- Adblock Plus 混合规则数量：4615
- uBlock Origin 混合规则数量：4614
- AdGuard 拦截规则数量：4615
- AdGuard 白名单数量：4355
- AdGuard Home 拦截规则数量：4615
- AdGuard Home 白名单数量：4355
- Clash 混合规则数量：10273（若文件不存在）
- Surge 混合规则数量：5138（若文件不存在）
- Pi-hole 拦截规则数量：2568
- Pi-hole 白名单数量：2568
