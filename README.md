...
## 统计信息
- 最后更新时间：2025-08-26 12:53:57
- Hosts规则数量：0

### 各拦截器规则数量
- Adblock Plus 混合规则数量：0
- uBlock Origin 混合规则数量：0
- AdGuard 拦截规则数量：184660
- AdGuard 白名单数量：15754
- AdGuard Home 拦截规则数量：6
- AdGuard Home 白名单数量：6
- Clash 混合规则数量：1（若文件不存在）
- Surge 混合规则数量：2（若文件不存在）
- Pi-hole 拦截规则数量：0
- Pi-hole 白名单数量：0
