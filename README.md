...
## 统计信息
- 最后更新时间：2025-08-21 20:32:56
- Hosts规则数量：48473

### 各拦截器规则数量
- Adblock Plus 混合规则数量：45386
- uBlock Origin 混合规则数量：53754
- AdGuard 拦截规则数量：42508
- AdGuard 白名单数量：9859
- AdGuard Home 拦截规则数量：40631
- AdGuard Home 白名单数量：8188
- Clash 混合规则数量：10763（若文件不存在）
- Surge 混合规则数量：0（若文件不存在）
- Pi-hole 拦截规则数量：48473
- Pi-hole 白名单数量：5866
